...
class TerrainGenerator:
    def __init__(self, chunk_size: int = 200, seed: int = 0):
...
class EntityGenerator:
    ...
    def generate_decorative_entities(self, center_x: float, center_y: float,
                                     count: int = 15):
...
class WorldGenerator:
    ...
    def initialize_world(self, player_x: float, player_y: float):
        ...
        self.entity_gen.generate_decorative_entities(player_x, player_y,
                                                     count=15)
    ...
    def generate_area_around_player(self, player_x: float, player_y: float):
        ...
        chunks_to_generate = int(self.generation_radius /
                                 self.terrain_gen.chunk_size) + 1
